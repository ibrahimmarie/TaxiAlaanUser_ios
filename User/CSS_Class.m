...
+ (void)APP_BlackbuttonPayment:(UIButton *)button
{
    button.titleLabel.font = [UIFont fontWithName:@"ClanPro-NarrMedium" size:16];
    button.frame = CGRectMake(button.frame.origin.x, button.frame.origin.y, button.frame.size.width, 60);
    button.layer.cornerRadius = 5.0f;
...
+ (void)APP_textfield_custom:(UITextField *)textField
{
    textField.font=[UIFont fontWithName:@"ClanPro-Book" size:16];
    ...
    textField.layer.borderColor = TEXTCOLOR_LIGHT.CGColor;
    textField.layer.masksToBounds = NO;
    textField.layer.shadowRadius = 4.0;
    textField.layer.shadowColor = TEXTCOLOR_LIGHT.CGColor;
